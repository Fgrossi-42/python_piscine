...
plot1 = plt.subplot2grid((3, 3), (0, 0), rowspan=2, colspan=2, fig= plt.figure(figsize=(20,12)))
plot2 = plt.subplot2grid((3, 3), (0, 2), rowspan=3, colspan=2)
plot3 = plt.subplot2grid((3, 3), (2, 0), rowspan=5,  colspan=2)
cars = []
cars2 = []
cars3 = []
i = 0
...
plot3.legend(loc="upper right", labels=leg, shadow=True)
plot3.set_ylim(ymin=0, ymax=5000, auto=True)
...
for index in range(len(years)):
	plot3.text(years[index], crimes[index] + 250, crimes[index], size=12, )
...
plot1.legend(loc="upper left", labels=cars, bbox_to_anchor=(1,1), ncol=1, fancybox=True, shadow=True, prop={'size': 12})
